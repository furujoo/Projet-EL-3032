...
//////////////////////////////////////////////////// INITIALISATION /////////////////////////////////////////////////////////////////
    ...
    char serveur[TAILLE_MAX][50];       //variable pour la liste des serveurs  
    int nb_serv = 0;                    //NOMBRE DE SERVEUR

    //ouverture du fichier de configuration des serveurs
    FILE *ListeServ = fopen("../Projet-EL-3032-main/Base de donnée/ListeServer.txt", "r");
